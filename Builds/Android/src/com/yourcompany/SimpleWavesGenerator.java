...
//==============================================================================
public class SimpleWavesGenerator   extends Activity
{
    //==============================================================================
    static
    {
    ...
    public MidiDeviceManager getAndroidMidiDeviceManager()
    {
        ...
        synchronized (SimpleWavesGenerator.class)
        {
               ...
               .setPositiveButton ("OK", new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.cancel();
                            SimpleWavesGenerator.this.alertDismissed (callback, 0);
                        }
                    });
               ...
               .setPositiveButton ("OK", new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.cancel();
                            SimpleWavesGenerator.this.alertDismissed (callback, 1);
                        }
                    })
               ...
               .setNegativeButton ("No", new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.cancel();
                            SimpleWavesGenerator.this.alertDismissed (callback, 2);
                        }
                    })
